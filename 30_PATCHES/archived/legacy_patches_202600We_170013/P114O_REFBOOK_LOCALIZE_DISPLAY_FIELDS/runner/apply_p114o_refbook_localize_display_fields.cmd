...
set "PATCH_ROOT=%WORKSPACE_ROOT%\patches\P114O_REFBOOK_LOCALIZE_DISPLAY_FIELDS"
...
if not exist "%ASAP_ROOT%\framework\Asap\RefBook\I18n\RefBookDocumentationI18nCatalog.php" (
  echo P114O_ASAP_I18N_CATALOG_MISSING
  exit /b 1
)

if not exist "%REFBOOK_ROOT%\application\reference\Service\ReferenceCatalogService.php" (
  echo P114O_REFBOOK_CATALOG_SERVICE_MISSING
  exit /b 1
)

copy /Y "%REFBOOK_ROOT%\application\reference\Service\ReferenceCatalogService.php" "%PATCH_ROOT%\backup\ReferenceCatalogService.php.bak" >nul

php "%~dp0p114o_refbook_localize_display_fields.php"
if errorlevel 1 exit /b 1

php -l "%REFBOOK_ROOT%\application\reference\Service\ReferenceCatalogService.php"
if errorlevel 1 exit /b 1

php "%~dp0p114o_refbook_localize_display_fields_smoke.php"
if errorlevel 1 exit /b 1
...
echo P114O_REFBOOK_LOCALIZE_DISPLAY_FIELDS_APPLY_OK
