...
set "PATCH_ROOT=H:\MAESTRO_WORKSPACE\patches\P114N3_REFBOOK_CONSUME_ASAP_I18N"

if not exist "%PATCH_ROOT%\backup\AbstractRefBookController.php.bak" (
  echo P114N3_ROLLBACK_ABSTRACT_BACKUP_MISSING
  exit /b 1
)

if not exist "%PATCH_ROOT%\backup\ReferenceRuntimeSnapshotRepository.php.bak" (
  echo P114N3_ROLLBACK_REPOSITORY_BACKUP_MISSING
  exit /b 1
)
