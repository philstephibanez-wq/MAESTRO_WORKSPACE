...
// Example: ASAP_REF_BOOK fetches the official ASAP RefBook snapshot.
// Contract: the RefBook app consumes REST JSON; it does not scan H:\ASAP.

$json = file_get_contents('http://127.0.0.1:8793/api/refbook/snapshot');
if (!is_string($json)) {
    throw new RuntimeException('ASAP_REFBOOK_API_READ_FAILED');
}
