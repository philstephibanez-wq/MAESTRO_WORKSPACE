...
L’assistant prépare et remet le ZIP dans cette conversation. L’owner l’applique localement, valide, puis committe et pousse OPUS/OWASYS. VS Code est utilisé comme éditeur, terminal et interface Git locale ; il n’exécute aucun agent Codex dans ce workflow.
