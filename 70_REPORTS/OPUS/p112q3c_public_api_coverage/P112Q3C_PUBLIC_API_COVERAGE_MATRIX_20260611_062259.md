...
Generated at: `2026-06-11T06:22:59+00:00`
...
| Methods in RefBook-tagged source | 580 |
...
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\LocalizedRefBookDocumentationProvider` | `__construct` | no | yes | yes | `framework/Opus/RefBook/Api/LocalizedRefBookDocumentationProvider.php:50` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\LocalizedRefBookDocumentationProvider` | `localizeSnapshot` | no | yes | no | `framework/Opus/RefBook/Api/LocalizedRefBookDocumentationProvider.php:58` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\LocalizedRefBookDocumentationProvider` | `localizeSymbol` | no | yes | no | `framework/Opus/RefBook/Api/LocalizedRefBookDocumentationProvider.php:77` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationAssetRepository` | `__construct` | no | no | yes | `framework/Opus/RefBook/Api/RefBookDocumentationAssetRepository.php:75` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationAssetRepository` | `diagram` | yes | yes | yes | `framework/Opus/RefBook/Api/RefBookDocumentationAssetRepository.php:131` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationAssetRepository` | `example` | yes | yes | yes | `framework/Opus/RefBook/Api/RefBookDocumentationAssetRepository.php:114` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationAssetRepository` | `index` | no | yes | yes | `framework/Opus/RefBook/Api/RefBookDocumentationAssetRepository.php:94` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationAssetRepository` | `refBookDomain` | no | no | yes | `framework/Opus/RefBook/Api/RefBookDocumentationAssetRepository.php:71` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationI18nRestRouter` | `__construct` | no | yes | yes | `framework/Opus/RefBook/Api/RefBookDocumentationI18nRestRouter.php:46` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookDocumentationI18nRestRouter` | `handle` | no | yes | yes | `framework/Opus/RefBook/Api/RefBookDocumentationI18nRestRouter.php:58` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookRestApi` | `__construct` | no | no | yes | `framework/Opus/RefBook/Api/RefBookRestApi.php:73` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Api\RefBookRestApi` | `handle` | yes | yes | yes | `framework/Opus/RefBook/Api/RefBookRestApi.php:89` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookRestApi` | `refBookDomain` | no | no | yes | `framework/Opus/RefBook/Api/RefBookRestApi.php:69` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookRestSnapshotProvider` | `__construct` | no | no | yes | `framework/Opus/RefBook/Api/RefBookRestSnapshotProvider.php:75` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookRestSnapshotProvider` | `endpoints` | no | no | yes | `framework/Opus/RefBook/Api/RefBookRestSnapshotProvider.php:133` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\Api\RefBookRestSnapshotProvider` | `refBookDomain` | no | no | yes | `framework/Opus/RefBook/Api/RefBookRestSnapshotProvider.php:70` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Api\RefBookRestSnapshotProvider` | `snapshot` | yes | yes | yes | `framework/Opus/RefBook/Api/RefBookRestSnapshotProvider.php:94` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Attribute\OpusRefBookClass` | `__construct` | yes | no | yes | `framework/Opus/RefBook/Attribute/OpusRefBookClass.php:66` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Attribute\OpusRefBookClass` | `toArray` | yes | no | yes | `framework/Opus/RefBook/Attribute/OpusRefBookClass.php:91` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Attribute\OpusRefBookMethod` | `__construct` | yes | no | yes | `framework/Opus/RefBook/Attribute/OpusRefBookMethod.php:80` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Attribute\OpusRefBookMethod` | `toArray` | yes | no | yes | `framework/Opus/RefBook/Attribute/OpusRefBookMethod.php:111` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Contract\RefBookInspectableInterface` | `refBookDomain` | yes | no | no | `framework/Opus/RefBook/Contract/RefBookInspectableInterface.php:40` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\I18n\RefBookDocumentationI18nCatalog` | `all` | no | yes | yes | `framework/Opus/RefBook/I18n/RefBookDocumentationI18nCatalog.php:5561` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\I18n\RefBookDocumentationI18nCatalog` | `translateSourceText` | no | yes | no | `framework/Opus/RefBook/I18n/RefBookDocumentationI18nCatalog.php:5541` |
| MISSING_TEST_REFERENCE | REFBOOK | `Opus\RefBook\I18n\RefBookDocumentationLocale` | `assertSupported` | no | no | no | `framework/Opus/RefBook/I18n/RefBookDocumentationLocale.php:44` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\I18n\RefBookDocumentationLocale` | `supported` | no | yes | no | `framework/Opus/RefBook/I18n/RefBookDocumentationLocale.php:39` |
| INTEGRATION_ONLY | REFBOOK | `Opus\RefBook\I18n\RefBookDocumentationTranslationMissingException` | `forSourceText` | no | yes | no | `framework/Opus/RefBook/I18n/RefBookDocumentationTranslationMissingException.php:36` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookClassEntry` | `__construct` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookClassEntry.php:37` |
| MISSING_TEST_REFERENCE | REFBOOK | `Opus\RefBook\Model\RefBookClassEntry` | `hasMetadata` | no | no | no | `framework/Opus/RefBook/Model/RefBookClassEntry.php:84` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookClassEntry` | `methods` | yes | yes | yes | `framework/Opus/RefBook/Model/RefBookClassEntry.php:94` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookClassEntry` | `name` | yes | yes | yes | `framework/Opus/RefBook/Model/RefBookClassEntry.php:76` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookClassEntry` | `toArray` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookClassEntry.php:104` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookMethodEntry` | `__construct` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookMethodEntry.php:36` |
| MISSING_TEST_REFERENCE | REFBOOK | `Opus\RefBook\Model\RefBookMethodEntry` | `hasMetadata` | no | no | no | `framework/Opus/RefBook/Model/RefBookMethodEntry.php:80` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookMethodEntry` | `name` | yes | yes | yes | `framework/Opus/RefBook/Model/RefBookMethodEntry.php:72` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookMethodEntry` | `toArray` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookMethodEntry.php:90` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookScanResult` | `__construct` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookScanResult.php:37` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookScanResult` | `classes` | yes | yes | yes | `framework/Opus/RefBook/Model/RefBookScanResult.php:48` |
| MISSING_TEST_REFERENCE | REFBOOK | `Opus\RefBook\Model\RefBookScanResult` | `loadErrors` | no | no | no | `framework/Opus/RefBook/Model/RefBookScanResult.php:58` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookScanResult` | `summary` | yes | yes | yes | `framework/Opus/RefBook/Model/RefBookScanResult.php:68` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\Model\RefBookScanResult` | `toArray` | yes | no | yes | `framework/Opus/RefBook/Model/RefBookScanResult.php:99` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\RefBookContractValidator` | `validate` | yes | yes | yes | `framework/Opus/RefBook/RefBookContractValidator.php:39` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\RefBookReflectionScanner` | `scan` | yes | yes | yes | `framework/Opus/RefBook/RefBookReflectionScanner.php:63` |
| UNIT_CANDIDATE | REFBOOK | `Opus\RefBook\RefBookSnapshotBuilder` | `build` | yes | yes | yes | `framework/Opus/RefBook/RefBookSnapshotBuilder.php:42` |
