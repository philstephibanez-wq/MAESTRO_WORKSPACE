# OPUS P117U HF7R2 — DÉCISION I18N DES APPLICATIONS GÉNÉRÉES R1

Date : 2026-07-24  
Statut : décision owner obligatoire avant correction  
Remplace : `OPUS_P117U_HF7R2_GENERATED_SITE_I18N_DECISION_SPEC_2026-07-24.md`  
...
Le sélecteur OWASYS visible sur une capture avec `Français` indique uniquement la locale active. Une capture fermée ne prouve pas le nombre d’options disponibles. L’écart est fondé sur le contenu réel de `SiteScaffoldPlan.php`, pas sur une interprétation visuelle.
...
## 5. Décision owner requise

Faut-il faire évoluer le framework OPUS afin que toute application générée reçoive les 24 langues officielles de l’Union européenne plus l’ukrainien, avec locale initiale négociée depuis `Accept-Language` et fallback explicite diagnostiqué ?
